...
{
    public class GrpcWebAutoMapperProfileStep : CSharpModificationCreatorStep
    {
            ...
            WorkflowExecutionContext context, CompilationUnitSyntax rootUnit)
        {
            ...
            string usingText = TextGenerator.GenerateByTemplateName(templateDir, "GrpcWebAutoMapperProfile_Using", model);

            string contents =
                TextGenerator.GenerateByTemplateName(templateDir, "GrpWebAutoMapperProfile_CreateMap", model);
        ...
        public GrpcWebAutoMapperProfileStep([NotNull] TextGenerator textGenerator) : base(textGenerator)
        {
